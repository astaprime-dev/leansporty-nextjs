...
/**
 * Shared auth UI (Google / Apple / email magic-link) used by BOTH the in-funnel
 * modal (oauth-signin-modal) and the standalone /sign-in page. One component →
 * the two surfaces stay identical.
 *
 * `next` is the path to resume after auth (intent resume, UX-FR-2). It's threaded
 * into all three flows: the magic-link redirect and — via a hidden field read by
 * the OAuth server actions — Google/Apple too.
 */
