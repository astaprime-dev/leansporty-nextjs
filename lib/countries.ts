/**
 * Country list for the payout-details form — aligned with Stripe's checkout
 * country selector: ISO 3166-1 alpha-2, minus the countries Stripe itself
 * excludes (sanctions: CU, IR, KP, SY) and RU/BY (no payout rails). Names are
 * STATIC (generated once from Intl.DisplayNames, English) — runtime Intl
 * differs between Node and browsers and caused a hydration mismatch. Codes are
